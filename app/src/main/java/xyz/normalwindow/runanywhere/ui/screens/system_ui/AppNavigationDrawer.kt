...
import xyz.normalwindow.runanywhere.ui.navigation.ConsumerDestination
import xyz.normalwindow.runanywhere.ui.navigation.ConsumerNavGroup
...
private fun DrawerContent(
    ...
    Column(
        ...
        DrawerActionItem(
            label = AppLocale.text("New chat"),
            description = AppLocale.text("Start a clean conversation"),
        ...
        DrawerActionItem(
            label = AppLocale.text("Search chats"),
            description = AppLocale.text("All saved conversations"),
        ...
        ConsumerNavGroup.entries.forEach { group ->
            ...
            if (entries.isNotEmpty()) {
                ...
                Text(
                    text = AppLocale.text(group.title),
                ...
                entries.forEach { entry ->
                    ...
                    DrawerActionItem(
                        label = AppLocale.text(entry.label),
                        description = AppLocale.text(entry.description),
...
private fun DrawerHeader() {
    ...
    Row(
        ...
        Column {
            ...
            Text(
                text = AppLocale.text("Private AI on this device"),
