package xyz.normalwindow.runanywhere.ui.screens.solutions
...
fun SolutionsScreen(viewModel: SolutionsViewModel = viewModel()) {
    ...
    Column(
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(dimens.spacingMd)) {
            RunButton(
                label = AppLocale.text("Voice Agent"),
            ...
            Surface(
                ...
                Column(
                    ...
                    if (viewModel.isCheckingModels) {
                        Text(AppLocale.text("Checking downloaded models…"))
                    } else {
                        Text(AppLocale.text("Download the required models before running a solution."))
                    ...
                    TextButton(
                        ...
                        Text(AppLocale.text(if (viewModel.isCheckingModels) "Checking…" else "Refresh"))
                    }
                }
            }
        }
